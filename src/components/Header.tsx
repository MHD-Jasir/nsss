...
import { Calendar, LogIn, LogOut, Menu, X, Image } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  const handleMobileNavigation = (view: typeof currentView) => {
    onViewChange(view);
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="rounded-full overflow-hidden w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center bg-white">
                <img src="/mamo-logo.png" alt="College" className="w-full h-full object-contain" />
              </div>
              <div className="rounded-full overflow-hidden w-8 h-8 sm:w-12 sm:h-12 flex items-center justify-center">
                <img src="/download.png" alt="NSS" className="w-full h-full object-cover" />
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <div className="text-sm">
                    ...
                    <div className="text-xs opacity-75 capitalize">{userInfo?.type} Portal</div>
                  </div>
                </button>
                <button
                  onClick={onLogout}
